...
class serviceBetter extends Conversation
{

    public function askReason()
    {
        $question = Question::create("Вы можете посмотреть преимущества нашей компании на главной странице. Я ответил на Ваш вопрос?")
