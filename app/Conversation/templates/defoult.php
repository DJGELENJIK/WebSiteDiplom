...
namespace App\Conversation\templates;
...
class defoult extends Conversation
{

    public function askReason()
    {
        $question = Question::create("Звонок поступит в течение 15 минут. Я ответил на Ваш вопрос?")
